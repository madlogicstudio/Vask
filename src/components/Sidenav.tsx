...
function Sidenav({setIsOpen, isDark} : SidenavProps) {
    ...
    return (
        <div className={`${isDark? '' : ''}
            h-screen w-full bg-[var(--light-color)] flex flex-col items-start justify-start gap-[1rem] py-[1rem] px-[0.5rem] absolute top-0 left-0 z-3
            ...
            <div className="flex-1 w-full flex flex-col items-start justify-start gap-[0.5rem] p-[0.5rem] pb-[0rem]">
                <span className='w-full border-b-2 border-[var(--dark-color)] py-[0.5rem] font-semibold text-[1rem] cursor-pointer hovered-light'>Home</span>
                <span className='w-full border-b-2 border-[var(--dark-color)] py-[0.5rem] font-semibold text-[1rem] cursor-pointer hovered-light'>Docs</span>
                <span className='w-full border-b-2 border-[var(--dark-color)] py-[0.5rem] font-semibold text-[1rem] cursor-pointer hovered-light'>Contact</span>
                <span className='w-full border-b-2 border-[var(--dark-color)] py-[0.5rem] font-semibold text-[1rem] cursor-pointer hovered-light'>About Us</span>
            </div>  
            ...
            <div className="flex-1 w-full flex flex-col items-start justify-start gap-[0.5rem] pt-0 pb-[1rem] px-[0.5rem]">
                <div className="w-full flex flex-col items-start justify-start gap-[0.5rem]">
                    <img src={Qr} className='h-[14rem] w-[14rem] cursor-pointer' alt="" />
                    <div className="h-full w-full flex flex-row items-center justify-start gap-[0.5rem]">
                        <div className='w-full flex-1 flex flex-row items-center justify-center cursor-pointer p-[0.5rem] gap-[0.5rem] bg-[var(--dark-color)] rounded-xl'

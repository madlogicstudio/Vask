    ...
    return (
        <div className={`${isDark ? "text-[var(--light-color)] bg-[var(--dark-color)]" : "bg-[var(--light-color)] text-[var(--dark-color)]"}
            ...
            <div className={`${isMobile? "flex-col" : "flex-row items-center justify-between"}
                ...
                <span className='text-[length:var(--small-font)] font-semibold cursor-pointer transition duration-300 ease-in-out'>
                    We value your privacy
                </span>
                <div className={`${isMobile? "justify-start py-[calc(0.6vw+0.4rem)]" : "justify-center"}
                    flex items-center gap-[0.5em]`}>
                    <span className="px-[calc(1.2vw+0.8rem)] py-[calc(0.4vw+0.3rem)] text-[length:var(--extrasmall-font)] rounded-full text-white bg-black cursor-pointer
            ...
            <div className={`${isMobile? "flex-col items-start" : "flex-row items-center"}
                ...
                <span className='text-[length:var(--extrasmall-font)] cursor-pointer transition duration-300 ease-in-out'>
                ...
                <span className='text-[length:var(--extrasmall-font)] text-blue-500 underline cursor-pointer transition duration-300 ease-in-out'>
                    Cookie Policy
                </span>
            </div>
        </div>
